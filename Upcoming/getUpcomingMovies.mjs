...
const getUpcomingMovies = async (page=1) => {
    ...
    const res =await fetch(`${upcomingUrl}&page=${page}`);  
...
const handleUpcomingPageChange = createPageHandler(getUpcomingMovies, createGetTotalPages(upcomingUrl));

export{handleUpcomingPageChange };